...
const getAllRecord=()=>(dispatch)=>{
   ...
   return axios.get("http://localhost:8000/records/getallrecords").then((r)=>{
...
const updateRecord=(id,payload,onClose)=>(dispatch)=>{
  ...
  return axios.patch(`http://localhost:8000/records/update/${id}`,payload).then((r)=>{
...
const deleteRecord=(id)=>(dispatch)=>{
  ...
  return axios.delete(`http://localhost:8000/records/delete/${id}`).then((r)=>{
...
const updateProfilepic=(Id,payload,onClose)=>(dispatch)=>{
  ...
  return axios.patch(`http://localhost:8000/records/updatepic/${Id}`,payload).then((r)=>{
